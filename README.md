...
shiny::runApp("path/to/Shiny-FlyDreamR_0.1.3/")
```

The GUI allows you to: - Upload and convert master files interactively - Configure analysis parameters via dropdown menus - Run both traditional and HMM analyses - Generate and download plots - Export results as CSV files
