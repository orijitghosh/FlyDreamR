...
The result is a `behavr` table with one row per minute per fly, containing columns for raw activity counts (`activity`), sleep annotation (`asleep`), day number (`day`), light/dark phase (`phase`), and normalized activity (`normact`).
