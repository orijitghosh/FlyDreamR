...
`TimeSpentInEachState` summarizes how many minutes each fly spent in each inferred state per day and phase. `VITERBIDecodedProfile` contains the full minute-by-minute decoded state sequence for every fly.
